...
$bookingsraw = $pdo->query("select s.movie_id, s.showtime, b.quantity, m.title, m.poster from movies m, bookings b join seances s on s.id=b.seance_id where b.user_id=$user_id and s.movie_id=m.id;");
